...
\begin{document}
	...
	\setlength\itemsep{-.25em}
	\fontsize{11}{0} \selectfont
	\item Manages a team of 20 undergraduates to build a self-steering, self-balancing bicycle
	\item Act as a liason between Cornell College of Engineering and the team
	\item Developing obstacle detection computer vision capabilities using OpenCV and ROS
	\end{itemize}
	\vspace{.7em}
	...
	\begin{itemize}[leftmargin=1.5cm]
		...
		\item Served as a TA for CS 2112 (Honors Object-Oriented Design \& Data Structures)
...
\group{Research}
	...
	\jobCaption{Cornell Graphics and Vision Group Research Assistant}{2018}\\[-1.75em]
	\begin{itemize}[leftmargin=1.5cm]
		\setlength\itemsep{-.25em}
		\fontsize{11}{0} \selectfont 
